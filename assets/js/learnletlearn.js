// assets/js/learnletlearn.js
(function(){
  'use strict';
  const Q_URL = '/assets/data/learnletlearn_questions.json';
  ...
  function checkAnswer(option, buttonEl) {
    ...
    if(option === q.a) {
      ...
      msg.innerText = '✗ Not quite. The correct answer is: ' + escapeHtml(q.a);
      ...
      setTimeout(()=> { 
        ...
        idx++; 
        renderQuestion();
      }, 2000); // Increased from 1200ms to 2000ms for better readability
    }
  }
  ...
  fetch(Q_URL)
    ...
    .catch(err => { 
      console.error('Learn & Let Learn load error', err); 
